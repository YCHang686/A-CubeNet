...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/media/data1/hyc/Deblock',
...
parser.add_argument('--quality', type=str, default='2',
                    help='Q/10 of JPEG Deblocking 1,2,3,4')
